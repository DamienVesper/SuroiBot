import { InteractionContextType, MessageFlags, SlashCommandBuilder, type ChatInputCommandInteraction } from "discord.js";
...
class Clear extends Command {
    ...
    run = async (interaction: ChatInputCommandInteraction): Promise<void> => {
        ...
        player.queue.clear();
        await interaction.followUp({ embeds: [this.client.createApproveEmbed(interaction.user, "Cleared the queue.")] });
    };
}
